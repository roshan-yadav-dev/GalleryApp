...
public final class DatabaseModule_ProvideDatabaseFactory implements Factory<GalleryDatabase> {
  ...
  public static GalleryDatabase provideDatabase(Context context) {
